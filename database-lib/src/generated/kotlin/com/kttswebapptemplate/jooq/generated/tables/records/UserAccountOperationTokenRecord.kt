...
open class UserAccountOperationTokenRecord private constructor() :
    ...
    Record4<String?, String?, UUID?, Instant?> {
    ...
    override fun valuesRow(): Row4<String?, String?, UUID?, Instant?> =
        super.valuesRow() as Row4<String?, String?, UUID?, Instant?>
    ...
    override fun field4(): Field<Instant?> =
    ...
    override fun value4(value: Instant?): UserAccountOperationTokenRecord {
        set(3, value)
        return this
    }
    ...
    constructor(token: String, tokenType: String, userId: UUID, creationDate: Instant) : this() {
        this.token = token
