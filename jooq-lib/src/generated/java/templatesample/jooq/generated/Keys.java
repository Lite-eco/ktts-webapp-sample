...
public class Keys {
    ...
    public static final UniqueKey<FormerMailRecord> FORMER_MAIL_PKEY = Internal.createUniqueKey(FormerMailTable.FORMER_MAIL, DSL.name("former_mail_pkey"), new TableField[] { FormerMailTable.FORMER_MAIL.ID }, true);
    ...
    public static final ForeignKey<FormerMailRecord, AppUserRecord> FORMER_MAIL__FORMER_MAIL_USER_ID_FKEY = Internal.createForeignKey(FormerMailTable.FORMER_MAIL, DSL.name("former_mail_user_id_fkey"), new TableField[] { FormerMailTable.FORMER_MAIL.USER_ID }, Keys.APP_USER_PKEY, new TableField[] { AppUserTable.APP_USER.ID }, true);
