...
import templatesample.jooqlib.Configuration.configuration
import templatesample.jooqlib.utils.FileUtils
...
object GenerateJooqAndDiff {
    ...
    val webServerResourcesDir by lazy { projectDir.resolve("template-sample-server/src/main/resources") }
    ...
    fun generate() {
        ...
        try {
            ...
            JooqGeneration.generateJooq(
                ...
                generatedPackageName = "templatesample.jooq",
