...
class SerializeAsStringDeserializer<T : SerializeAsString>(val templateSampleStringIdClass: KClass<T>) :
    StdDeserializer<T>(templateSampleStringIdClass.java) {

    companion object {
        fun <T : SerializeAsString> deserialize(templateSampleStringIdClass: KClass<T>, value: String) =
