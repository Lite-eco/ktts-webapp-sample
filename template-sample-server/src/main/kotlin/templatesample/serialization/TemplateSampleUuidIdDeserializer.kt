...
class TemplateSampleUuidIdDeserializer<T : TemplateSampleUuidId>(val templateSampleUuidIdClass: KClass<T>) :
    StdDeserializer<T>(templateSampleUuidIdClass.java) {

    companion object {
        fun <T : TemplateSampleUuidId> deserialize(templateSampleUuidIdClass: KClass<T>, value: String): T =
