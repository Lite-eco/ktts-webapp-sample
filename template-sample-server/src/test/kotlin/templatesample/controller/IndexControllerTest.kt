...
internal class IndexControllerTest(@Autowired val indexController: IndexController) {
    ...
    fun `test magic link url rewriting`() {
        ...
        assertEquals(
            ...
            indexController.rewriteQueryString(
                mapOf("param1" to arrayOf("value1"), "param2" to arrayOf("value2"))))
        assertEquals(
            "param1=value1&param2=value2",
            indexController.rewriteQueryString(
                mapOf(
        ...
        assertEquals(
            "param1=value11&param1=value12&param2=value2",
            indexController.rewriteQueryString(
                mapOf("param1" to arrayOf("value11", "value12"), "param2" to arrayOf("value2"))))
    }
}
